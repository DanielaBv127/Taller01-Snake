...
public class SnakeModel extends GameModel {
	...
	private static final GameTile FRUIT_TILE = new RoundTile(new Color(180, 0, 0), Color.GREEN, 3.0); //Cambio de color.
	...
	private static final GameTile SNAKE_HEAD_TILE = new RectangularTile(Color.BLUE); //Cambio de color.
